...
values."
  (setq-default
   ...
   ;; Lazy instalM-x all-the-icons-install-fontslation of layers (i.e. layers are installed only when a file
...
you should place your code here."
  ...
  ;; org-mode setup
  ;; keywords
  (setq org-todo-keywords '((sequence "TODO(t)" "WAITING(w)" "CONSIDER(p)"
                                      "|" "DONE(d)" "CANCELLED(c)")))
